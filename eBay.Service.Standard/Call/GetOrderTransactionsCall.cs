...
namespace eBay.Service.Call
{
	...
	public class GetOrderTransactionsCall : ApiCall
	{
		...
		/// </param>
		///
		public OrderType[] GetOrderTransactions(ItemTransactionIDType[] ItemTransactionIDArrayList, String[] OrderIDArrayList, TransactionPlatformCodeType Platform, bool IncludeFinalValueFees)
		{
		...
		/// </summary>
		public ItemTransactionIDType[] ItemTransactionIDArrayList
		{ 
		...
		/// </summary>
		public String[] OrderIDArrayList
		{ 
		...
		/// </param>
		///
		public OrderType[] GetOrderTransactions(ItemTransactionIDType[] ItemTransactionIDArrayList)
		{
			this.ItemTransactionIDArrayList = ItemTransactionIDArrayList;
		...
		/// </param>
		///
		public OrderType[] GetOrderTransactions(String[] OrderIDArrayList)
		{
