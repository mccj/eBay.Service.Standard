...
namespace eBay.Service.Call
{
    ...
    public class GetBidderListCall : ApiCall
    {
        ...
        /// </param>
        ///
        public List<ItemType> GetBidderList(bool ActiveItemsOnly, DateTime EndTimeFrom, DateTime EndTimeTo, string UserID, GranularityLevelCodeType GranularityLevel)
        {
        ...
        {
            get { return ApiRequest.ActiveItemsOnly.Value; }
        ...
        /// </summary>
        public List<ItemType> BidItemList
        {
