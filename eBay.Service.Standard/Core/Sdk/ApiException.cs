...
namespace eBay.Service.Core.Sdk
{
	...
	public class ApiException: SdkException, ISerializable
	{
		...
		public ApiException(List<ErrorType> errors)
		{
			mErrors = errors;
		}
		...
		{
			mErrors = (List<ErrorType>) info.GetValue("mErrors", typeof(List<ErrorType>));
		...
		{
			info.AddValue("mErrors", mErrors, typeof(List<ErrorType>));
		...
		private List<ErrorType> mErrors = new List<ErrorType>();
		#endregion
