...
namespace eBay.Service.Core.Sdk
{
	...
	public class ExceptionFilter
	{
		...
		/// <summary>
		/// Converts comma-separated list of error codes into the appropriate List<string> ready to set into the filter.
		/// </summary>
		/// <param name="configString"></param>
		/// <returns></returns>
		public static List<string> ParseTriggerErrorCodes(string configString)
		{
        ...
        /// <summary>
        /// Converts comma-separated list of integer status codes into the appropriate List<Int32> ready to set into the filter.
        /// </summary>
        /// <param name="configString"></param>
        /// <returns></returns>
        public static List<Int32> ParseTriggerHttpStatusCodes(string configString)
		{
			if (configString == null || configString.Length == 0)
				return null;
        ...
        /// <summary>
        /// Converts comma-separated list of exception type names into the appropriate List<Type> ready to set into the filter.
        /// </summary>
        /// <param name="configString"></param>
        /// <returns></returns>
        public static List<Type> ParseTriggerExceptions(string configString)
		{
			if (configString == null || configString.Length == 0)
				return null;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the error codes that retry should occur for of type <see cref="List<string>"/>.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the exception types that retry should occur for of type <see cref="List<Type>"/>.
		/// </summary>
		...
		private List<string> mTriggerErrorCodes = new List<string>();
		private List<Int32> mTriggerHttpStatusCodes = new List<Int32>();
		private List<Type> mTriggerExceptions = new List<Type>();
